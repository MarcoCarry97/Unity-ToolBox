...
class maker_solver:
    ...
    def solve(self, num_levels, num_rooms, size, distance,path,space,num_trap,num_treasure,num_item,rand_init,corr_size,num_enemy):
        ...
        files = ["assign_size.lp", "rooms_doors.lp","positions.lp", "expansion.lp","expand_pos.lp","initial_end.lp", "add_stairs.lp", "add_traps.lp","add_treasures.lp", "add_keys.lp","add_items.lp","enemy_spawn.lp"]
        incomplete_models=[]
